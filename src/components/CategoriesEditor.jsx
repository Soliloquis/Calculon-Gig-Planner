    ...
    <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', gap: '20px', padding: '24px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: '24px', alignItems: 'start' }}>
        ...
        <div className="glass-panel" style={{ background: 'rgba(15, 23, 42, 0.4)', padding: '16px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <h4 style={{ fontSize: '15px', fontWeight: '700', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
            ➕ Create Custom Category
          </h4>
          
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div className="form-group">
              <label style={{ fontSize: '13px', color: 'var(--text-muted)' }}>Category Name</label>
              <input
                type="text"
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              <div className="form-group" style={{ flex: 1 }}>
                <label style={{ fontSize: '13px', color: 'var(--text-muted)' }}>Icon Emoji</label>
                <input
                  type="text"
                  className="form-input"
                  maxLength="2"
              ...
              <div className="form-group" style={{ width: '80px' }}>
                <label style={{ fontSize: '13px', color: 'var(--text-muted)' }}>Color</label>
            ...
            <button type="submit" className="btn btn-primary" style={{ width: '100%', padding: '8px', fontSize: '14px', marginTop: '4px' }}>
              🎨 Create Category
            </button>
          </form>
        </div>
